...
<a href="<?php echo url_for('/teacher/index.php'); ?>">Ope-Intraan</a><br><br>
                ...
                <div class="users listing">
                    ...
                    <!-- <?php while($student = mysqli_fetch_assoc($student_set)) { ?> -->
                        <tr>
                            ...
                            <td><a class="action" href="<?php echo url_for('/teacher/show.php?id=' .h(u($student['id']))) ?>">View</a></td>
                            <td><a class="action" href="<?php echo url_for('/teacher/edit.php?id=' . h(u($student['id'])));?>">Edit</a></td>
                            <td><a class="action" href="<?php echo url_for('/teacher/delete.php?id=' . h(u($student['id'])));?>">Delete</a></td>
                            </tr>
                    <?php } ?>
                    </table>
                    <br><br><br><br><br>
...
<?php
include(SHARED_PATH . '/teacher_footer.php');
?> 
